                ...
                <div class="col-lg-12">
                    ...
                    data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar" style="text-align: center;">
                        ...
                        <tbody id="tbl_bilheter">
                            ...
                            $sql = 'SELECT bilhete.idBilhete,cliente.nome,cliente.apelido, bilhete.numero,bilhete.estado,bilhete.fpagamento,bilhete.horaCompra,sessao.data,sessao.horaInicio, sessao.preco, usuario.nomeUsuario,usuario.apelidoUsuario FROM bilhete INNER JOIN cliente ON bilhete.idCliente=cliente.idCliente INNER JOIN sessao ON bilhete.idSessao=sessao.id INNER JOIN usuario ON usuario.id=bilhete.idUsuario WHERE bilhete.tipo="vendido"';                                                        
                            ...
                            if($num >=1){
                                ...
                                <td><?php echo $linha[10]." ".$linha[11]?></td>
                                </tr>
