...
<body>
    ...
    <div class="all-content-wrapper">
            ...
            <!-- Eh aquiiiii, adicao de salas-->
                ...
                <div class="product-payment-inner-st">
                    <ul id="myTabedu1" class="tab-review-design">
                        <li class="active"><a href="#description">Salas</a></li>
                        </ul>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="review-content-section" id="divEditar">
                                            <form method="POST" id="salinha">
                                            <div class="row">
                                                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <label for="sala">Nome da Sala</label>
                                                    <input name="sala" type="text" class="form-control" placeholder="Nome da Sala" id="nome" required="">
                                                </div>
                                                <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <label for="capacidade">Capacidade</label>
                                                    <input name="capacidade" type="text" class="form-control" placeholder="capacidade" id="capacidade" required="">
                                                </div>
                                              </div>
                                               <div id="results"></div>
                                                <div class="form-actions row">
                                                <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                                <input type="button" class="btn btn-primary" value="GRAVAR" onclick="adicionarSala()">
                                                <input type="reset" class="btn btn-primary" id="btnCancelar" value="CANCELAR" id="apagar">
                                            </div>
                                        </div>
                                  </form>
                               </div>
        ...
        <!-- Eh aquiiiii, fim adicao de salas, comeco de tabela sla-->
                    ...
                    data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar" style="text-align: center;">
                        <thead>
                            <tr>
                                ...
                                <th data-field="id">#</th>
                                <th data-field="nomeSala" data-editable="false">Nome da Sala</th>
                                <th data-field="capacidade" data-editable="false">Capacidade</th>
