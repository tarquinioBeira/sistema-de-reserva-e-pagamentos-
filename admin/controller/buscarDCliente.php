...
$nivelAcesso = $linha[8];
 ...
 $form ='
        ...
        <div class="row">
           ...
           <div class="row">
                     <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                     <label for="listasessao">Lista de Sessões</label>
                     <select name="sessao" class="form-control" id="sessao" required="" value"'.$listaSessoes.'">
                    <option selected="">--Selecione a Sessão--</option>
                    <?php include_once 'action/select/sessao.php'; ?>
                     </select>
                     </div>
            </div>
            <div id="results"></div>
