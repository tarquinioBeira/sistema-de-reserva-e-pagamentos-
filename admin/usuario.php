...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <!-- Eh aquiiiii, onde o admin irá cadastrar o usuário -->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Sobre Ususários</a></li>
                            </ul>
                                                    ...
                                                    <form method="POST">
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <input name="morada" type="text" class="form-control" id="morada" required="">
                                                            </div>
                                                           </div>
                                                            <div class="row">
                                                                <div class="form-group col-lg-4 col-md-6   col-sm-6 col-xs-12">
                                                           ...
                                                           <div class="row">
                                                                     ...
                                                                     <select name="nivelAcesso" class="form-control" id="nivelAcesso" required="">
                    ...
                    data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                        <thead>
                            <tr>
                                ...
                                <th data-field="apelido" data-editable="false">Apelido</th>
                                <th data-field="contacto" data-editable="false">Contacto</th>
                                <th data-field="morada">Morada</th>
                                <th data-field="usuario" data-editable="false">Usuário</th>
                                <th data-field="nivelacesso" data-editable="false">Nivel de Acesso</th>
                        ...
                        if($num >=1){
                            ...
                            <td><?php echo $linha[10]?></td>
                            <td><?php echo $linha[8]?></td>
                            <td>
                                <button class="action print btn btn-outline-success" onclick="buscarUsuario(<?php echo $linha[0];?>)"><i class="fa fa-edit" style="color: green"></i></button>
                                <button class="action print btn btn-outline-success" onclick="apagarUsuario(<?php echo $linha[0];?>)"><i class="fa fa-trash" style="color: red"></i></button>
                            </td>
                            </tr>
    ...
    <!-- Fecho de tudo que tem haver com o Funcionário-->
