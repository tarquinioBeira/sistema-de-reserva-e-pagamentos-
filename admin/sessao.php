                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-payment-inner-st">
                        <ul id="myTabedu1" class="tab-review-design">
                            <li class="active"><a href="#description">Sessões</a></li>
                              </ul>
                                  <div class="review-content-section" id="divEditar">
                                    <form method="POST">
                                        ...
                                        <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <select name="filme" class="form-control" id="filme" required="">
                                                        <option selected="">--Selecione o filme--</option>
                                                        <?php include_once 'action/select/filme.php'; ?>
                                                </select>
                                        </div>
                                        <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-lg-4 col-md-6   col-sm-6 col-xs-12">
                                                ...
                                                <input name="horatermino" type="time" class="form-control" id="horatermino" required="">
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                                 <label for="sala">Sala</label>
                                                 <select name="sala" class="form-control" id="sala" required="">
                                                        <option selected="">--Selecione a sala--</option>
                                                        <?php include_once 'action/select/sala.php'; ?>
                                                </select>
                                            </div>
                                            <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                            ...
                                            <div id="results"></div>
                                              ...
                                              <div class="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                                    <input type="button" class="btn btn-primary" value="GRAVAR" onclick="adicionarSessao()">
                    ...
                    data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                        <thead>
                            <tr>
                                ...
                                <th data-field="id">#</th>
                                <th data-field="filme" data-editable="false">Filme</th>
                                <th data-field="data" data-editable="false">Data</th>
                                <th data-field="horainicio" data-editable="false">Hora de Início</th>
                                <th data-field="horatermino" data-editable="false">Hora de Término</th>
                                <th data-field="sala" data-editable="false">Sala</th>
                                <th data-field="preco" data-editable="false">Preço (MT)</th>
                                ...
                                if($num >=1){
                                    ...
                                    <td>
                                <button class="action print btn btn-outline-success" onclick="buscarSessao(<?php echo $linha[0];?>)"><i class="fa fa-edit" style="color: green"></i></button>
